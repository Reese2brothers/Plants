...
@Composable
fun TreesScreen(navController: NavController) {
    Box(modifier = Modifier
        ...
        Column(
            ...
            LazyColumn(modifier = Modifier.fillMaxSize().padding(top = 4.dp)
                ...
                val listCharsT = listOf("А","Б","В","Г","Д","Е","Ж","З","И","К","Л","М","Н","О","П",
                ...
                items(28){itemT ->
                    Card(
                        ...
                        onClick = { navigateToScreenTrees(listCharsT[itemT], navController) }
                    ) {
                        Row(
                            ...
                            Text(text = listCharsT[itemT], modifier = Modifier.padding(top = 8.dp, start = 24.dp),
