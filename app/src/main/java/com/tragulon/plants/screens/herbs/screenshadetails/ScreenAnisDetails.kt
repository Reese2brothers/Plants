...
@Composable
fun ScreenAnisDetails(){
    val images = listOf(R.drawable.a_anis, R.drawable.a_aniss, R.drawable.a_anisss, R.drawable.a_anissss, R.drawable.a_anisssss)
    ...
    LaunchedEffect(favouriteItems) {
        isFavorite = favouriteItems.any { it.imageResId == R.drawable.a_anis && it.title == "Анис обыкновенный" }
    }
    Box(
        ...
        Column(
            ...
            Box(
                ...
                IconButton(onClick = {
                    scope.launch {
                        if (isFavorite) {
                            viewModel.removeFromFavourites(R.drawable.a_anis, "Анис обыкновенный", "ScreenAnisDetails")
                            isFavorite = !isFavorite
                        } else {
                            viewModel.addToFavourites(R.drawable.a_anis, "Анис обыкновенный",  "ScreenAnisDetails")
                            isFavorite = !isFavorite
                        }
                    }},
            ...
            Text(text = stringResource(id = R.string.anis),
                modifier = Modifier
