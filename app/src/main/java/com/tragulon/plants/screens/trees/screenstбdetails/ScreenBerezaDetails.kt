...
@Composable
fun ScreenBerezaDetails(){
    val images = listOf(
        R.drawable.b_bereza, R.drawable.b_berezaa, R.drawable.b_berezaaa, R.drawable.b_berezaaaa,
        R.drawable.b_berezaaaaa, R.drawable.b_berezaaaaaa)
    ...
    LaunchedEffect(favouriteItems) {
        isFavorite = favouriteItems.any { it.imageResId == R.drawable.b_bereza && it.title == "Береза белая" }
    }
    Box(
        ...
        Column(
            ...
            Box(
                ...
                IconButton(onClick = {
                    scope.launch {
                        if (isFavorite) {
                            viewModel.removeFromFavourites(R.drawable.b_bereza, "Береза белая", "ScreenBerezaDetails")
                            isFavorite = !isFavorite
                        } else {
                            viewModel.addToFavourites(R.drawable.b_bereza, "Береза белая",  "ScreenBerezaDetails")
                            isFavorite = !isFavorite
                        }
                    }},
            ...
            Text(text = stringResource(id = R.string.bereza),
                modifier = Modifier
